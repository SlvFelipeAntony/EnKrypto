...
<body class="css-index-body vw-100 vh-100 d-flex justify-content-center align-items-center" data-bs-theme=dark>
        ...
        <div class="w-100 h-100 px-3 py-4 pb-3 bg-dark rounded login">
            <form action="#" method="post"><!-- <img class="mb-4" src="/docs/5.3/assets/brand/bootstrap-logo.svg" alt="" width="72" height="57">s -->
                ...
                <div class="input-group form-floating my-2"><input type="password" class="form-control password" id="loginPass" placeholder="Password" name="pass" value="<?php if (isset($_COOKIE["pass"])) {
                                                                                                                                                                                echo $_COOKIE["pass"];
                                                                                                                                                                            } ?>" require><label for="floatingPassword">Senha</label><button type="button" value="hide" class="btn btn-outline-light showPassword" data-bs-toggle="button">
                ...
                <div class="checkbox mt-2 mb-3"><label><input type="checkbox" value="remember" name="remember"> Lembre-me</label></div><button class="w-100 btn btn-lg btn-outline-success my-2 mb-3" type="submit">Entrar</button>
            </form>
            <a href="cadastro.php" type="button" class="cadastrar w-100 btn btn-dark text-secondary-emphasis">Cadastrar-se</a>
